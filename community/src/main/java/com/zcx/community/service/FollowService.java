    ...
    public void follow(int userId, int entityType, int entityId) {
        redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations operations) throws DataAccessException {
                // 拿到key
                String followeeKey = RedisKeyUtils.getFolloweeKey(userId, entityType); // userId关注的实体
                String followerKey = RedisKeyUtils.getFollowerKey(entityType, entityId); // entity拥有的粉丝
                // 开启事务
                operations.multi();
                // 做两次存储操作
                operations.opsForZSet().add(followeeKey, entityId, System.currentTimeMillis()); // 用户关注了什么
                operations.opsForZSet().add(followerKey, userId, System.currentTimeMillis()); // 什么关注了entity
